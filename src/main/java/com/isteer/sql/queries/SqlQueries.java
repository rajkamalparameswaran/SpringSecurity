...
public class SqlQueries {
	...
	public static final String GET_USER_BY_ID = "SELECT USERID,USERNAME,USERFULLNAME,USEREMAIL,USERPASSWORD,ISACCOUNTNONEXPIRED,ISACCOUNTNONLOCKED,ISCREDENTIALSNONEXPIRED,ISENABLED FROM USER WHERE USERID=?";
	...
	public static final String GET_ALL_USERS = "SELECT USERID,USERNAME,USERFULLNAME,USEREMAIL,USERPASSWORD,ISACCOUNTNONEXPIRED,ISACCOUNTNONLOCKED,ISCREDENTIALSNONEXPIRED,"
			+ "ISENABLED,ADDRESS,ROLE FROM USER,ADDRESS,AUTHORITY WHERE USERID=FK_ADDRESS_USERID AND USERID=FK_AUTHORITY_USERID";

	public static final String GET_USER_BY_USERNAME = "SELECT USERID,USERNAME,USERFULLNAME,USEREMAIL,USERPASSWORD,ISACCOUNTNONEXPIRED,ISACCOUNTNONLOCKED,ISCREDENTIALSNONEXPIRED,ISENABLED FROM USER WHERE USERNAME=?";
	...
	public static final String GET_ALL_END_POINT = "SELECT ENDPOINTID,ENDPOINTNAME FROM ENDPOINTS";
